...
companyRouter.route("/update").post(upload.single('logo'), // Add multer middleware
(req, res) => new company_controller_1.CompanyController().updateCompany(req, res));
companyRouter.route("/delete").post((req, res) => new company_controller_1.CompanyController().deleteCompany(req, res));
companyRouter.route("/get_all").get((req, res) => new company_controller_1.CompanyController().getAllCompanies(req, res));
